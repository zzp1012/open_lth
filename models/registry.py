...
from models import cifar_resnet, cifar_resnet_plus, cifar_vgg, mnist_lenet, imagenet_resnet
from models import bn_initializers, initializers
from platforms.platform import get_platform

registered_models = [mnist_lenet.Model, cifar_resnet.Model, cifar_resnet_plus.Model, cifar_vgg.Model, imagenet_resnet.Model]
