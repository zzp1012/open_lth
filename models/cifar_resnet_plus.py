...
class Model(base.Model):
    ...
    def __init__(self, plan, initializer, outputs=None):
        ...
        self.layer1 = self._make_layer(current_filters, 64, plan[0], 1)
        self.layer2 = self._make_layer(64, 128, plan[1], 2)
        self.layer3 = self._make_layer(128, 256, plan[2], 2)
        self.layer4 = self._make_layer(256, 512, plan[3], 2)
    ...
    def _make_layer(self, current_filters, filters, num_blocks, stride):
        strides = [stride] + [1]*(num_blocks-1)
        layers = []
        for stride in strides:
            downsample = stride != 1
            layers.append(Model.Block(current_filters, filters, downsample))
    ...
    def is_valid_model_name(model_name):
        return (model_name.startswith('cifar_resnet_') and
                ...
                int(model_name.split('_')[2]) in [18, 34])
